        ...
        <div class="col-lg-3 col-md-6 col-sm-12">
            <div class="widget">
                <div class="widget-body">
                    ...
                    <small class="text-small mt-10 d-block">plus élevé que le mois dernier</small>
                </div>
        ...
        <div class="col-lg-3 col-md-6 col-sm-12">
            <div class="widget">
                <div class="widget-body">
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="state">
                            <h6>Véhicule sorti aujourd'hui</h6>
